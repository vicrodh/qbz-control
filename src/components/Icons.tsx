...
export function IconControls({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconNext({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconPrevious({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M19 5v14l-9-7 9-7Z" />
    </svg>
  );
}

export function IconQueue({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <polygon points="19 16 19 22 22 19 19 16" fill="currentColor" />
    </svg>
  );
}
...
export function IconHeart({ size = 20, filled = false, ...props }: IconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconInfinity({ size = 20, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
